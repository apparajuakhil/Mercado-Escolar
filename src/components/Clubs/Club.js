...
const Club = () => {
  return (
   ...
   <div><NavLink to={"add/5"}>
   <button style={{    float: "right",
    margin: "2% 5%"}}>
            <span class="data-title" style={{float: "right"}}>Create Club</span>
            </button>
          </NavLink></div>
  ...
  <li class="card">
    ...
    <button style={{padding: "20px 25px",marginBottom: "10px"}}>Join Now</button>
...
<br/>
<div><center><h1>My Clubs</h1></center></div>
<br/>
<br/>
...
<ul class="card-wrapper">
  ...
  <li class="card">
    ...
    <h3><a href="">A Super Wonderful Headline</a></h3>
    <p>Lorem ipsum sit dolor amit</p>
    <button style={{padding: "20px 25px",marginBottom: "10px"}}>Leave</button>
  </li>
  <li class="card">
    <img src='https://images.unsplash.com/photo-1611083360739-bdad6e0eb1fa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MXwxNDU4OXwwfDF8cmFuZG9tfHx8fHx8fHw&ixlib=rb-1.2.1&q=80&w=400' alt=''/>
    <h3><a href="">What a Fantabulous Title!</a></h3>
